<script>
  import InviteParticipantInput from "../components/InviteParticipantInput.svelte";
  import ParticipantBadge from "../components/ParticipantBadge.svelte";
...
<div class="flex flex-col h-full">
  ...
  <form class="w-full flex-1 min-h-0 p-1 pt-2 overflow-y-auto">
    ...
    <button type="submit" class="btn primary !w-64 block ml-auto" on:click|preventDefault={emitData}>Create and upload</button>
  </form>
</div>
