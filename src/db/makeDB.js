export default function makeDB({
  ...
  const projects = {
    ...
    search: queryParams => queryCollection('projects', queryParams), 
  }
  ...
  const projectBatches = {
    ...
    search: queryParams => queryCollection('projectBatches', queryParams)
  }
  ...
  const projectParticipants = {
    ...
    search: queryParams => queryCollection('projectParticipants', queryParams), 
    /**
  ...
  const specimenImages = {
    ...
    search: queryParams => queryCollection('specimenImages', queryParams) 
  }
  ...
  const specimens = {
    ...
    search: queryParams => queryCollection('specimens', queryParams), 
  }
  ...
  const users = {
    ...
    search: qryParams => queryCollection('users', qryParams), 
  }
